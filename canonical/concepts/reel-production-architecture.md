...
## Continuous PC asset production — Adrian-direct, 12 September 2026

Classification: user-authorised operational development of the SS work-ahead amendment, not a global dispatcher or fleet-priority change. Adrian requires the creative team to feed the PC independently of individual edit blockers, potentially around the clock. Codex owns strategy, viewer engagement, rich storyboards and generation briefs; Claude owns execution through the existing machine. The canonical operational home is **“Continuous PC production and the ready-work buffer”** in `working/content-machine/2026-09-07-six-month-strategy/SS-CONTENT-CONTROL.md`; creative handoff detail is in the SS skill's production contract §4. Use a dependency-aware ready queue and one admitted native GPU job at a time, with truthful runtime receipts. No static/jittered fallback, unapproved selections, invented 24/7 operation or new paid/model-polling service. This amendment permits work ahead, not skipped gates or overlapping final reel repairs.

## SS24 work-ahead B-roll — Adrian-direct, 12 September 2026

Classification: user-authorised scheduling amendment, not a new dispatcher or fleet-priority change. Adrian requested lining up already-described B-roll for other reels while blocked editing work is resolved. Keep one final flagged edit at a time; permit the existing Claude owner to prepare and generate independent assets for stable, user-described story beats from already-selected reels. Such asset work may precede final speech lock, with trim handles and provisional placement; qualified final-master speech, complete timed storyboard and exact captions remain required before assembly. Use one claimed GPU job through the existing PC controller, preserve its recovery lifecycle and all original approvals. New/replacement selections still require selection approval. Prepared, submitted, generating, asset-QC-passed, integrated and final-approved are distinct states. A source/audio blocker on one reel must not idle other eligible B-roll. This narrow amendment supersedes older restrictions on all visual work before speech lock, not the creative or release requirements. Operational commission: SS24 project `work/PC-BROLL-WORK-AHEAD-20260912.md`.
