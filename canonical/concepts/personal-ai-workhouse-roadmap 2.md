...
> ChatGPT's older multi-node cluster doc (several M3 Ultras + 2–3 M2 Ultra 192GB + M2 64GB + minis) is being located by a team search and will be folded into §5 when found.
...
- These need the high-RAM Ultra hosts (§4). This is where ChatGPT's old cluster doc fits — to be folded in.
...
3. Fold in ChatGPT's cluster doc (team locating it) → finalise §5.
