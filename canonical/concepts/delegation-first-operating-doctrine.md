...
**§10.3 — The multi-pod fleet** (live as of 2026-06-21: M1 Max MacBook [brain] + M2 Mac Studio [worker] + i7 Intel Mac [specialist offload — reactivating 2026-06-22 once a replacement charger lands] + M4 Mac mini 24GB [INCOMING, ordered 2026-06-21 — 2nd Apple-Silicon inference node: small/medium local-LLM + MLX Whisper + the Council-Rotation §10.4 2nd $0 engine; ceiling ~14B, 32B+ stays M2]; M3 SOLD, M1 Ultra purchase cancelled):
